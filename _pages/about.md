...
# 📖 Educations
<img src="/images/sss.jpg" alt="ByteDance" width="120" height="20"/> *2021.09 - now*, [Department of Sociology](https://www.soc.tsinghua.edu.cn/#), [School of Social Sciences](https://www.sss.tsinghua.edu.cn/), [Tsinghua University](https://www.tsinghua.edu.cn/en/), **PhD student**, Sociology of Science
...
博士期间，获得两次国家奖学金、清华之友——九坤奖学金（一等）、公共管理未来学者奖学金等。

本科期间，获得国家奖学金、唐仲英德育奖学金、郭秉文奖助学金等奖助学金，江苏省优秀学生干部、校优秀毕业生、校优秀学生干部、校优秀团干部、校学习优秀生、校三好学生、校本科优秀毕业论文等荣誉称号。

# 🏢 学生工作

博士期间，曾担任清华大学研究生培养咨询委员会委员、清华大学团委青年研究中心学生导师、清华大学公共管理学院研究生团总支副书记。
...
立足科学技术与社会（STS）视角，特别聚焦于人工智能和数字技术带来的深远社会变革。从多个维度考察了技术对社会各方面的影响，核心领域包括：数字社会形态的演变与公共治理的转型；科技伦理的理论基础、治理体系构建与教育实践；科技的社会文化属性、其传播机制与公众认知；以及人工智能在医疗健康领域的具体应用与伦理挑战。
...
![中科院1区TOP](https://img.shields.io/badge/中科院1区TOP-yellow) ![Letter](https://img.shields.io/badge/Letter-blue) **Wang S**, Kinoshita S, Yokoyama H M. [Write Your Paper on the Motherland?](https://doi.org/10.1080/08989621.2024.2347398)[J]. Accountability in Research, 2024, published online. 
...
![中科院1区TOP](https://img.shields.io/badge/中科院1区TOP-yellow) ![Letter](https://img.shields.io/badge/Letter-blue) **Wang S**. [Before We Trust: Concerns for Using ChatGPT in Medical Communication](https://pubs.rsna.org/doi/10.1148/radiol.241888)[J]. Radiology,2025, 314(01): 1-2. 

![中科院1区TOP](https://img.shields.io/badge/中科院1区TOP-yellow) ![Letter](https://img.shields.io/badge/Letter-blue) **Wang S**, Kinoshita S, Yokoyama H M. [Shifting Focus—From ChatGPT to Specialised Medical LLMs](https://onlinelibrary.wiley.com/doi/full/10.1111/apt.18121)[J]. Alimentary Pharmacology & Therapeutics, 2024, 60(3): 417-417.

![中科院1区TOP](https://img.shields.io/badge/中科院1区TOP-yellow) ![Letter](https://img.shields.io/badge/Letter-blue) **Wang S**. [Comment on: Predicting Glaucoma Before Onset Using a Large Language Model Chatbot](https://doi.org/10.1016/j.ajo.2024.06.035)[J]. American Journal of Ophthalmology, 2024, 266: 321. 

![中科院2区TOP](https://img.shields.io/badge/中科院2区TOP-yellow) ![Letter](https://img.shields.io/badge/Letter-blue) **Wang S**, Kinoshita S, Yokoyama H M. [Performance of ChatGPT and GPT-4 on Neurosurgery Written Board Examinations](https://journals.lww.com/neurosurgery/fulltext/9900/letter__performance_of_chatgpt_and_gpt_4_on.1329.aspx)[J]. Neurosurgery, 2024, 95(5):p e151-e152. 

![中科院2区](https://img.shields.io/badge/中科院2区-yellow) ![Letter](https://img.shields.io/badge/Letter-blue) **Wang S**. [Beyond ChatGPT: It Is Time to Focus More on Specialized Medical LLMs](https://www.liebertpub.com/doi/10.1089/end.2024.0374)[J]. Journal of Endourology, 2024, published online.

![中科院3区](https://img.shields.io/badge/中科院3区-yellow) ![Letter](https://img.shields.io/badge/Letter-blue) Kinoshita S, **Wang S**, Kishimoto T. [Uneven Distribution of Physicians by Specialty in East Asia](https://jkms.org/DOIx.php?id=10.3346/jkms.2024.39.e129)[J]. Journal of Korean Medical Science, 2024, 39(12). 
...
.lang-btn.active {
  /* 例如：激活状态的按钮样式 */
  /* background-color: #007bff; */ /* 你的主题可能已经有激活状态的 .btn--info 样式 */
  /* color: white !important; */
  text-decoration: underline;
  font-weight: bold;
  /* border-bottom: 2px solid #007bff; */ /* 另一种高亮方式 */
}
.language-content {
  /* 可以不加额外样式，或者按需添加 */
}
...
function showLanguage(lang) {
  ...
  if (lang === 'en') {
    ...
    // 如果是从 #show-zh 切换回英文，清除 URL 中的 hash
...
document.addEventListener('DOMContentLoaded', function() {
  // 默认显示英文内容，并设置英文按钮为激活状态
  // （HTML中已通过 style="display: block;" 设置英文为默认显示，这里确保按钮状态）
  showLanguage('en'); 

  // 检查 URL hash 是否为 #show-zh，如果是，则显示中文内容
  if (window.location.hash === '#show-zh') {
    showLanguage('zh');
    // 可选：平滑滚动到中文内容区域的顶部
    var zhContentElement = document.getElementById('chinese-content');
    if (zhContentElement) {
      // 延迟一小段时间确保元素已显示，再滚动
      setTimeout(function() { 
        zhContentElement.scrollIntoView({ behavior: 'smooth', block: 'start' });
      }, 100);
    }
  }
});
